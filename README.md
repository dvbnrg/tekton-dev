...
- `ghEmergencyLabel` the label used for emergency PRs
- `gheIssueRepo` the repo where the compliance checker looks for incident issues
- `gheToken`: personal github enterprise token
- `gheUser`: the user who wants to run the pipeline
